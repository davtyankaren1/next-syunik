    ...
    <div className="min-h-screen bg-gradient-to-br from-background mt-4">
      ...
      <main className="pb-20 pt-4">
        ...
        <div className="mb-4">
          {/* <Button
            onClick={() => navigate("/")}
            className='flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 text-brand-text shadow-sm transition-all duration-300 hover:bg-brand-primary hover:text-white hover:shadow-md'
          >
